...
namespace CreateDbUpEverytimeScripts
{
    public abstract class Table
    {
        ...
        abstract protected void SetPrimaryKey();

        public virtual void AdjustColumns()
        {
            RemoveColumns();
            SetPrimaryKey();
            IgnoreIdentityProperty();
        }
        ...
        /// <summary>
        /// in transformed tables we don't use autogenerated Id's, but Ids from source database
        /// </summary>
        protected virtual void IgnoreIdentityProperty()
        {
            Columns.Where(c => c.IsIdentity)
                .ToList()
                .ForEach(c => c.IsIdentity = false);
        }
    }
}
